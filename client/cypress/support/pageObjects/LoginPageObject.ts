/**
 * Page Object for LoginPage component.
 * Encapsulates all selectors and actions — tests never use raw cy.get().
 */
export class LoginPageObject {
  usernameInput()  { return cy.get('input[placeholder*="alice"]'); }
